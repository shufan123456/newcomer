...
public class MysqlGenerator {
	 ...
	 * 数据库连接url
	 */
	private static final String dbUrl = "jdbc:mysql://172.16.20.168:3306/test?useUnicode=true&characterEncoding=utf-8&zeroDateTimeBehavior=convertToNull&useSSL=false&allowMultiQueries=true";
	/**
	 * 要生成代码的数据表
	 */
